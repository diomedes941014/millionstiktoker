...
// email verify
Route::get('/email/verify', [\App\Http\Controllers\VerificationController::class, 'verify'])->middleware('auth')->name('verification.notice');
Route::post('/email/verification-check', [\App\Http\Controllers\VerificationController::class, 'check'])->middleware(['auth'])->name('verification.check');
